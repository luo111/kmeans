...
public class KMeansRun {  
    ...
    public KMeansRun(int k, List<float[]> original_data) throws IOException {
        this.kNum = k;
  ...
  /*     Point point1=pointList.get(1);
        Point point2=pointList.get(11);
        Point point3=pointList.get(19);
        Cluster cluster1=new Cluster(0, point1);
        Cluster cluster2=new Cluster(1, point2);
        Cluster cluster3=new Cluster(2, point3);
